...
fancy-regex supports powerful features such as subroutines and recursion.
...
Its behavior depends on subtle implementation details
...
Because the first alternative allows recursion before any input is consumed.
...
Shifts errors from runtime to compile time
